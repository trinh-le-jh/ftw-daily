...
export class CheckoutPageComponent extends Component {
  ...
  render() {
    ...
    if (shouldRedirect) {
      ...
      return <NamedRedirect name="EquipmentListingPage" params={params} />;
    }
...
EquipmentCheckoutPage.setInitialValues = (initialValues, saveToSessionStorage = false) => {
...
EquipmentCheckoutPage.displayName = 'CheckoutPage';

export default EquipmentCheckoutPage;
