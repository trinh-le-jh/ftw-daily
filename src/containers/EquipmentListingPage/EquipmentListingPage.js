...
export class ListingPageComponent extends Component {
  ...
  render() {
    ...
    const listingType = isDraftVariant
      ? LISTING_PAGE_PARAM_TYPE_DRAFT
      : LISTING_PAGE_PARAM_TYPE_EDIT;
    const listingTab = isDraftVariant ? 'photos' : 'general';
    ...
    const bookingSubTitle = intl.formatMessage({ id: 'EquipmentListingPage.bookingSubTitle' });
    ...
    if (showListingError && showListingError.status === 404) {
      ...
      const errorTitle = intl.formatMessage({
        id: 'EquipmentListingPage.errorLoadingListingTitle',
      });
      ...
      const loadingTitle = intl.formatMessage({
        id: 'EquipmentListingPage.loadingListingTitle',
      });
    ...
    const schemaTitle = intl.formatMessage(
      { id: 'EquipmentListingPage.schemaTitle' },
    ...
    const equipmentOptions = findOptionsForSelectFilter('equipment', filterConfig);
            ...
            <div>
              ...
              <div className={css.contentContainer}>
                <div className={css.mainContent}>
                  ...
                  <SectionGeneral
                    description={description}
                    typeOptions={equipmentOptions}
                    selectedType={publicData.type}
